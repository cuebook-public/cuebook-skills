...
<p align="center">
  <a href="https://github.com/cuebook-public/cuebook-skills/releases/tag/v0.9.0"><img alt="Release v0.9.0" src="https://img.shields.io/badge/release-v0.9.0-F6C500?style=flat-square&labelColor=111111"></a>
...
For a reproducible, intentionally frozen install, add `--ref v0.9.0` to the marketplace command. A tag-pinned marketplace stays on that tag until you change the ref; the default `main` install receives stable releases.
