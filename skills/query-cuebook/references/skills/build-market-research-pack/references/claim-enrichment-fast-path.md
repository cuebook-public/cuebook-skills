...
| derived return, spread, or trigger | `get_candles` + local `../../compute-cuebook-market-indicators/SKILL.md` | formula, frozen inputs, synchronized window, sealing state, source refs |
