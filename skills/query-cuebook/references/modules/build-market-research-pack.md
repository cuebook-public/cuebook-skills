...
> Module resources are rooted at `references/modules/build-market-research-pack/` from the public Skill directory.
...
13. Return `ResearchPackV1`, run `references/modules/build-market-research-pack/scripts/validate_research_pack.mjs`, and repair all errors. Review warnings deliberately.
...
Read `references/modules/build-market-research-pack/references/claim-enrichment-fast-path.md` whenever raw creator language contains a current event, named news or PR premise, requested number, valuation multiple, comparator, relative-performance claim, market level, or settlement anchor.
...
Return the shape defined by `references/modules/build-market-research-pack/references/research-pack-v1.schema.json`:
...
- `references/modules/build-market-research-pack/templates/brief-template.md`: normalized research request.
- `references/modules/build-market-research-pack/references/source-policy.md`: source hierarchy, identity, basis, and freshness rules.
- `references/modules/build-market-research-pack/references/research-modules.md`: event-specific research modules and required fields.
- `references/modules/build-market-research-pack/references/claim-enrichment-fast-path.md`: creator-language triggers, exact support requests, news-anchor selection, and metric-basis resolution.
- `references/modules/build-market-research-pack/references/research-pack-v1.schema.json`: authoritative contract.
- `references/modules/build-market-research-pack/scripts/validate_research_pack.mjs`: deterministic cross-reference and safety checks.
- `references/modules/build-market-research-pack/evals/trigger_cases.json`: positive, neighboring, and adversarial routing cases.
- `references/modules/build-market-research-pack/evals/rubric.md`: research quality gate.
- `references/modules/build-market-research-pack/evals/failure_cases.md`: stable failure patterns.
