...
3. Invoke `../render-cuebook-market-post/SKILL.md` once in batch candidate mode. Return three Frame-sized `PostV1` siblings from the same plan with distinct expression briefs:
