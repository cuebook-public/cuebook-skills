...
11. Route the frozen thesis downstream. Use `../plan-market-content-program/SKILL.md` for a release family, `../render-cuebook-market-post/SKILL.md` for compact text, `../render-cuebook-market-media/SKILL.md` for structured media, `../render-cuebook-thesis-chart/SKILL.md` for a claim-bound market chart, `../compute-cuebook-market-indicators/SKILL.md` for deterministic OHLCV evidence, `../assemble-cuebook-viewpoint-card/SKILL.md` for the product preview, and `../prepare-market-content-release/SKILL.md` for final handoff.
