...
| --- | --- | --- |
| add or improve text | `../../render-cuebook-market-post/SKILL.md` | PostV1 |
| add news | `../../build-market-research-pack/SKILL.md` | sourced facts in ResearchPackV1 |
| add viewpoint logic | `../../compile-cuebook-visual-argument/SKILL.md` -> `../../render-cuebook-logic-card/SKILL.md` | VisualArgumentV1 + LogicCardV1 |
| add data-led figure | `../../render-cuebook-market-figure/SKILL.md` | MarketFigureSpecV1 + MarketFigureV1 |
| add chart | `../../render-cuebook-thesis-chart/SKILL.md` | ThesisChartV1 + chart asset |
| add indicator | `../../compute-cuebook-market-indicators/SKILL.md` | IndicatorPackV1 |
| add settlement footer | `../../compile-cuebook-settlement-claim/SKILL.md` | SettlementClaimV1 |
| generate preview | `../SKILL.md` | ViewpointCardV1 |
