...
The same export can feed `../../compute-cuebook-market-indicators/SKILL.md` after chart normalization, keeping visual and numeric evidence on one data snapshot.
