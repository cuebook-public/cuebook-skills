...
- This skill owns human intent and public settlement wording. `../compile-cuebook-settlement-formula/SKILL.md` owns executable math, typed variables, and lifecycle evaluation semantics.
