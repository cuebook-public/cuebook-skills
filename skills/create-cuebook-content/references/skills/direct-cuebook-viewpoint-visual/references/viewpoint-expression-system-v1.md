...
- **OHLC setup**: route the full evidence object through `../../render-cuebook-thesis-chart/SKILL.md`; the viewpoint composition may frame it but cannot simplify it into an invented line.
