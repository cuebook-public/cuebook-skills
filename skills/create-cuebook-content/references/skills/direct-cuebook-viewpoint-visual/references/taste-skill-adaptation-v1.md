...
- `9-10`: experimental composition; use only when the creator voice and evidence remain readable at 670px.
...
- `compact_readable`: the claim is legible and understandable at 670 x 264;
...
- Landing-page hero, CTA, navigation, logo-wall, and SEO rules: unrelated to a 2680 x 1056 market viewpoint.
