...
- Full OHLC, volume, or indicator analysis routes to `../render-cuebook-thesis-chart/SKILL.md` and can be embedded as the evidence hero.
...
- Do not synthesize a structured evidence object inside this Skill. Its `EOBJ_*` ref, shape, source refs, method metadata, and reconciliation must already pass `../assemble-cuebook-viewpoint-data/SKILL.md` and appear in `render_payload.evidence_object_refs`.
