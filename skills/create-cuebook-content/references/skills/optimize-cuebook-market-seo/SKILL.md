...
10. For owned-web content, pass planning constraints to `../render-cuebook-market-media/SKILL.md`; run this skill again in `preflight` after rendering. Use `../optimize-cuebook-market-geo/SKILL.md` alongside it when answer-engine readiness is requested, then send the final artifact to `../prepare-market-content-release/SKILL.md`.
