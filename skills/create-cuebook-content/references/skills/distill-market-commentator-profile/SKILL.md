...
- Authorized JSON, JSONL, or CSV: normalize with `../collect-market-commentator-corpus/SKILL.md`, then distill.
...
4. Normalize raw records with `../collect-market-commentator-corpus/SKILL.md`. Keep CorpusV1 as the provenance boundary.
