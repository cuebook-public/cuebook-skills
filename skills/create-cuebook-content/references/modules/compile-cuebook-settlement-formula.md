...
> Module resources are rooted at `references/modules/compile-cuebook-settlement-formula/` from the public Skill directory.
...
```bash
node references/modules/compile-cuebook-settlement-formula/scripts/validate_settlement_formula.mjs settlement-formula-v1.json
node references/modules/compile-cuebook-settlement-formula/scripts/validate_settlement_formula.mjs settlement-formula-v1.json --print-math
node references/modules/compile-cuebook-settlement-formula/scripts/validate_settlement_formula.mjs settlement-formula-v1.json --print-canonical-hash
```

## Resources

- `references/modules/compile-cuebook-settlement-formula/references/formula-patterns.md`: standard trading-view formulas and lifecycle rules.
- `references/modules/compile-cuebook-settlement-formula/references/backend-db-contract.md`: Cuebook table bindings, evaluator semantics, persistence gaps, and MCP requirements.
- `references/modules/compile-cuebook-settlement-formula/references/mcp-settlement-protocol.md`: registration, sealed observation, outcome, and receipt requirements for Cuebook MCP.
- `references/modules/compile-cuebook-settlement-formula/references/settlement-formula-v1.schema.json`: authoritative typed formula contract.
- `references/modules/compile-cuebook-settlement-formula/scripts/validate_settlement_formula.mjs`: type, lifecycle, public-math, and hash validator.
- `references/modules/compile-cuebook-settlement-formula/evals/trigger_cases.json`: routing examples.
