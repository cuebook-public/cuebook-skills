...
import { audit as auditChart } from "../references/skills/render-cuebook-thesis-chart/scripts/audit_chart_svg.mjs";
import { load_canonical_series, render_svg as renderChartSvg } from "../references/skills/render-cuebook-thesis-chart/scripts/render_thesis_chart.mjs";
import { validate as validateChart } from "../references/skills/render-cuebook-thesis-chart/scripts/validate_thesis_chart.mjs";
...
const rasterizerScript = fileURLToPath(new URL("../references/skills/render-cuebook-thesis-chart/scripts/rasterize_thesis_chart.cjs", import.meta.url));
...
const CHART_SCHEMA = JSON.parse(readFileSync(new URL("../references/skills/render-cuebook-thesis-chart/references/thesis-chart-v1.schema.json", import.meta.url), "utf8"));
const MARKET_SCHEMA = JSON.parse(readFileSync(new URL("../references/skills/render-cuebook-thesis-chart/references/market-series-batch-v1.schema.json", import.meta.url), "utf8"));
