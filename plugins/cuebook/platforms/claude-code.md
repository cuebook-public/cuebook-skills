...
For a reproducible frozen install, use `cuebook-public/cuebook-skills@v0.9.10` in the marketplace command. A tag-pinned marketplace stays on that release until its source is changed.
