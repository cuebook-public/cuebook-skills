...
Every TradingView-derived source is registered as restricted. A CDP chart capture may be shown locally but never uploaded raw. The default Frame route resolves the exact asset again, fetches eligible Cuebook data, recomputes reproducible geometry, and natively renders the standard 1866 × 1200 image.
