...
- Attach a derived delta or summary label to the gap or bracket between the marks it compares, clear of its own bracket stroke; a label beside one mark misattributes the quantity.
- A value labeled on the evidence geometry is stated once. Do not give the same number a second display-scale slot in the claim column; promote the derived quantity or the judgment instead.
