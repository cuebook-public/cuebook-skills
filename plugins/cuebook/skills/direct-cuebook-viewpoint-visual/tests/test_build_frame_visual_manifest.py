...
def capture_report(with_og: bool = False) -> dict:
    outputs = [
        {"kind": "full", "ref": "viewpoint-2488.png", "width": 2488, "height": 1056, "sha256": "sha256:" + "a" * 64},
        {"kind": "compact_622", "ref": "viewpoint-622.png", "width": 622, "height": 264, "sha256": "sha256:" + "b" * 64},
    ]
    if with_og:
        outputs.append({"kind": "og", "ref": "og-1200x630.png", "width": 1200, "height": 630, "sha256": "sha256:" + "c" * 64})
...
class ManifestBuilderTests(unittest.TestCase):
    def build(self, *, with_og: bool = False, audit_valid: bool = True, license_mode: str = "production", alt: dict | None = None):
        with TemporaryDirectory() as tmp:
            ...
            return BUILDER.build(capture_report(with_og=with_og), {"valid": audit_valid}, direction_set(), fonts, alt_text)
    ...
    def test_builds_manifest_with_stable_jcs_hash(self) -> None:
        ...
        self.assertEqual(manifest["capture_audit"], {"decision": "ready", "status": "passed"})
    ...
    def test_missing_compact_blocks_manifest(self) -> None:
        ...
        with TemporaryDirectory() as tmp:
            ...
            manifest, errors = BUILDER.build(report, {"valid": True}, direction_set(), fonts, {"publication": "x"})
