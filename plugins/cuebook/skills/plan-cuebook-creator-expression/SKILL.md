...
- Pass the same plan and fingerprint hash to `$render-cuebook-market-post` for reasoning-complete public text. Derive compact selector copy only when a downstream surface explicitly needs it.
