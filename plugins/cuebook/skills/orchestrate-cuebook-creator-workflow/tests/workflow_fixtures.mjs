...
export function baseRun() {
  ...
  return {
    ...
    catalog_version: "1.31.0", query_bundle_refs: [], selected_opportunity_refs: ["OPP_q2_revision"], mode: "single",
...
export function workflowRecipe() {
  ...
  return {
    schema_version: "content-recipe-v1", recipe_id: "RECIPE_1234abcd", catalog_version: "1.31.0",
