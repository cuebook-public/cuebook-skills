...
| Draft ends with `invalidation`, `I admit I was wrong`, or `what would prove this wrong` | Omit the forced boundary or rewrite a material counter-signal as a quiet reason to revisit the view |
