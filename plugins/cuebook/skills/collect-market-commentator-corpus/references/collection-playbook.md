...
Use this reference to turn already accessible material into `corpus.v1`. Collection ends at normalization; profile analysis belongs to `$distill-market-commentator-profile`.
