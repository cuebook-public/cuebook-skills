...
6. Choose a release strategy separately from the topology. Use relative order or event triggers here; exact account, time, approval, and execution mode belong to `$prepare-market-content-release`.
