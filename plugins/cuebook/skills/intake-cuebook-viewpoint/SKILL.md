...
- The optional creator interview happens at most once and before every settlement or price question. It uses at most two Cues and never treats another published view as proof, consensus, or creator adoption. `直接做`, `就按这个做`, `就这些`, `没有更多`, or an equivalent refusal closes it without another prompt.
