...
import { audit as auditChart } from "../../render-cuebook-thesis-chart/scripts/audit_chart_svg.mjs";
import { load_canonical_series, render_svg as renderChartSvg } from "../../render-cuebook-thesis-chart/scripts/render_thesis_chart.mjs";
...
const CHART_SCHEMA = JSON.parse(readFileSync(new URL("../../render-cuebook-thesis-chart/references/thesis-chart-v1.schema.json", import.meta.url), "utf8"));
const MARKET_SCHEMA = JSON.parse(readFileSync(new URL("../../render-cuebook-thesis-chart/references/market-series-batch-v1.schema.json", import.meta.url), "utf8"));
