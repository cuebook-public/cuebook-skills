...
No Settlement, duration, or range band is the default. Explicit creator terms always win; if Settlement is chosen and a term is missing, Cuebook asks whether the creator wants to state it or receive one or two Cue-, catalyst-, history-, or volatility-informed proposals, and nothing proceeds until the creator accepts or edits a proposal. Creators never choose sessions, trading days, or next close. Before finalizing media, Cuebook naturally recaps the exact copy, chosen image or Artifact, and any human Settlement rule. “Publish this” later authorizes only the external write.
