# Cuebook Frame Art Direction

Use this reference after the idea topology and evidence relationship are known. Art direction is an expression of the creator's idea, not a random template choice.

## Fixed identity and variable expression
...
- reading direction, chart share, narrative placement, geometry, headline system, material, density, and light/dark tone;
- do not vary facts, time semantics, settlement meaning, or evidence authority for visual novelty.

## Design families

| Design family | Best reader job | Composition | Visual silhouette |
| --- | --- | --- | --- |
| `signal_poster` | conviction or one strong curve | `curve_stage` | dominant evidence left, creator pulse right |
| `editorial_argument` | mechanism or reflective analysis | `editorial_split` | voice left, evidence right, generous negative space |
| `tension_field` | relative strength, drawdown, correlation | `divergence_field` | wide comparison field, judgment below |
