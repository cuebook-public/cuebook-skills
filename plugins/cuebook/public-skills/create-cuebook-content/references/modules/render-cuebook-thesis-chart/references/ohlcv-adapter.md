...
The same export can feed `references/modules/compute-cuebook-market-indicators.md` after chart normalization, keeping visual and numeric evidence on one data snapshot.
