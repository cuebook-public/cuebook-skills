...
> Module resources are rooted at `references/modules/assemble-cuebook-viewpoint-data/` from the public Skill directory.
...
2. Read `references/modules/assemble-cuebook-viewpoint-data/references/cuebook-data-supply.md`. Resolve instruments through durable entity and venue IDs before matching symbols.
...
```bash
node references/modules/assemble-cuebook-viewpoint-data/scripts/validate_viewpoint_data_bundle.mjs viewpoint-data-bundle-v1.json \
...
Return `ViewpointDataBundleV1` matching `references/modules/assemble-cuebook-viewpoint-data/references/viewpoint-data-bundle-v1.schema.json`.

## Resources

- `references/modules/assemble-cuebook-viewpoint-data/references/viewpoint-data-bundle-v1.schema.json`: normalized data and availability contract.
- `references/modules/assemble-cuebook-viewpoint-data/references/cuebook-data-supply.md`: Cuebook DB fields and visual-grammar supply map.
- `references/modules/assemble-cuebook-viewpoint-data/scripts/validate_viewpoint_data_bundle.mjs`: cutoff, OHLC, formula, reference, fallback, and state validator.
