...
> Module resources are rooted at `references/modules/normalize-cuebook-creator-feed/` from the public Skill directory.
...
5. Normalize each of the five inputs according to `references/modules/normalize-cuebook-creator-feed/references/input-semantics.md`:
...
9. Return `CreatorFeedV1`, run `references/modules/normalize-cuebook-creator-feed/scripts/validate_creator_feed.mjs`, and repair every error. Review warnings before opportunity selection.
...
Return the shape in `references/modules/normalize-cuebook-creator-feed/references/creator-feed-v1.schema.json`. The core sections are:
...
- `references/modules/normalize-cuebook-creator-feed/references/input-semantics.md`: allowed and prohibited uses for each Cuebook input.
- `references/modules/normalize-cuebook-creator-feed/references/creator-feed-v1.schema.json`: authoritative contract.
- `references/modules/normalize-cuebook-creator-feed/scripts/validate_creator_feed.mjs`: deterministic lineage, cutoff, permission, reference, and count checks.
- `references/modules/normalize-cuebook-creator-feed/evals/trigger_cases.json`: positive, neighboring, and adversarial routing cases.
- `references/modules/normalize-cuebook-creator-feed/evals/rubric.md`: intake quality gate.
- `references/modules/normalize-cuebook-creator-feed/evals/failure_cases.md`: stable failure patterns.
