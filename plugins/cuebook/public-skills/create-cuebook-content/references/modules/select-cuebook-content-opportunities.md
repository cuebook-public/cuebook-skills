...
> Module resources are rooted at `references/modules/select-cuebook-content-opportunities/` from the public Skill directory.
...
10. Recommend only the next work mode: quick post, research pack, content program, correction workflow, or postmortem. Channel and asset topology stay in ContentRecipeV1 and `references/modules/plan-market-content-program.md`.
11. Return `ContentOpportunitySetV1`, run `references/modules/select-cuebook-content-opportunities/scripts/validate_content_opportunities.mjs` with the feed, and repair every error.
...
Return the shape in `references/modules/select-cuebook-content-opportunities/references/content-opportunity-set-v1.schema.json`:
...
- `references/modules/select-cuebook-content-opportunities/references/content-opportunity-set-v1.schema.json`: authoritative contract.
- `references/modules/select-cuebook-content-opportunities/scripts/validate_content_opportunities.mjs`: deterministic feed-reference, ranking, dedupe, history-use, and gate checks.
- `references/modules/select-cuebook-content-opportunities/evals/trigger_cases.json`: routing cases.
- `references/modules/select-cuebook-content-opportunities/evals/rubric.md`: selection quality gate.
- `references/modules/select-cuebook-content-opportunities/evals/failure_cases.md`: stable selection failures.
