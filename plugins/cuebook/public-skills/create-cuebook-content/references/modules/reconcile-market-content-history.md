...
> Module resources are rooted at `references/modules/reconcile-market-content-history/` from the public Skill directory.
...
9. Return `ContentHistoryLedgerV1`, run `references/modules/reconcile-market-content-history/scripts/validate_content_history.mjs`, and repair every error.
...
Read `references/modules/reconcile-market-content-history/references/outcome-policy.md` before handling outcomes.
...
Return the shape in `references/modules/reconcile-market-content-history/references/content-history-ledger-v1.schema.json`:
...
- `references/modules/reconcile-market-content-history/references/outcome-policy.md`: state, outcome-plane, cohort, and claim rules.
- `references/modules/reconcile-market-content-history/references/content-history-ledger-v1.schema.json`: authoritative contract.
- `references/modules/reconcile-market-content-history/scripts/validate_content_history.mjs`: receipt, correction, outcome, cohort, and event checks.
- `references/modules/reconcile-market-content-history/evals/trigger_cases.json`: routing cases.
- `references/modules/reconcile-market-content-history/evals/rubric.md`: reconciliation quality gate.
- `references/modules/reconcile-market-content-history/evals/failure_cases.md`: stable failures.
