...
- `candidate` may route to `references/modules/compile-cuebook-settlement-claim.md`; list missing metric, operator, threshold, deadline, or authoritative source fields.
