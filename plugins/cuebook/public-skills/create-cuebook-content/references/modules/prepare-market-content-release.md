...
> Module resources are rooted at `references/modules/prepare-market-content-release/` from the public Skill directory.
...
2. Read `references/modules/prepare-market-content-release/references/platform-capabilities.md` for the requested destination. Recheck official capability and policy sources when the bundle may become `ready`.
...
```bash
node references/modules/prepare-market-content-release/scripts/validate_release_bundle.mjs release-bundle-v1.json
```
...
Return `ReleaseBundleV1` using `references/modules/prepare-market-content-release/references/release-bundle-v1.schema.json`.
...
- `references/modules/prepare-market-content-release/references/platform-capabilities.md`: current official capability routing and conservative defaults.
- `references/modules/prepare-market-content-release/references/release-bundle-v1.schema.json`: output contract.
- `references/modules/prepare-market-content-release/scripts/validate_release_bundle.mjs`: deterministic safety, state, dependency, schedule, and idempotency checks.
