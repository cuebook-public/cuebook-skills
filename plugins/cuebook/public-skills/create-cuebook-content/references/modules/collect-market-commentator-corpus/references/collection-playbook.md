...
Use this reference to turn already accessible material into `corpus.v1`. Collection ends at normalization; profile analysis belongs to `references/modules/distill-market-commentator-profile.md`.
