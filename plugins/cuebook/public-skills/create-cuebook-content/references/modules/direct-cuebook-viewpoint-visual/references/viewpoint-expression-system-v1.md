...
- **OHLC setup**: route the full evidence object through `references/modules/render-cuebook-thesis-chart.md`; the viewpoint composition may frame it but cannot simplify it into an invented line.
