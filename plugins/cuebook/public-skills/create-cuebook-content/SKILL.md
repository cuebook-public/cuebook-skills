...
- Prefer concrete actors, verbs, numbers, and dates. Weave sourced facts into the creator's argument. Never expose bracketed evidence labels, source headings, “author inference,” “this view selects long,” or observation/verification/invalidation checklists. Keep sourced fact, creator inference, and another creator's Cue distinct through attribution, not visible taxonomy. If polish changes meaning or attribution, restore the confirmed meaning.
